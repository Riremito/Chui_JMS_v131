                                        ...
                                        if (battlers[i == 1 ? 0 : 1].getCurrentHP() <= 0) {
                                            ...
                                            if (instanceid >= 0 && i == 0 && npcTeam == null) {
                                                ...
                                                if (Randomizer.nextInt(5) == 0) {
                                                    chr.modifyCSPoints(1, (int) ((Randomizer.nextInt(chr.getClient().getChannelServer().getCashRate()) + chr.getClient().getChannelServer().getCashRate() + mons.getExp() / 1000 + mons.getDefaultHp() / 20000) * (chr.getStat().cashBuff / 100.0) * chr.getCashMod()), true);
                                                }
