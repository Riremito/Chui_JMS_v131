...
public enum MapleBuffStat implements Serializable, Buffstat {
    ...
    //1 - debuff
    COMBO(0x200000, 2),
    SUMMON(0x0/*0x200000*/, 2), //hack buffstat for summons ^.- (does/should not increase damage... hopefully <3)
    WK_CHARGE(0x400000, 2),
    DRAGONBLOOD(0x800000, 2),
    HOLY_SYMBOL(0x1000000, 2),
    MESOUP(0x2000000, 2),
    SHADOWPARTNER(0x4000000, 2),
    PICKPOCKET(0x8000000, 2),
    PUPPET(0x8000000, 2), // HACK - shares buffmask with pickpocket - odin special ^.-

    MESOGUARD(0x10000000, 2),
    HP_LOSS_GUARD(0x20000000, 2),
    //4 - debuff
    //8 - debuff
    ...
    STANCE(0x10, 1),
    SHARP_EYES(0x20, 1),
    MANA_REFLECTION(0x40, 1),
    //8 - debuff

    SPIRIT_CLAW(0x100, 1),
    INFINITY(0x200, 1),
    HOLY_SHIELD(0x400, 1), //advanced blessing after ascension
    HAMSTRING(0x800, 1),
    BLIND(0x1000, 1),
    CONCENTRATE(0x2000, 1),
    //4 - debuff
    ECHO_OF_HERO(0x10000/*0x8000*/, 1),
    MESO_RATE(0x10000, 1), //confirmed
    GHOST_MORPH(0x20000, 1),
    ARIANT_COSS_IMU(0x40000, 1), // The white ball around you
    //8 - debuff

    DROP_RATE(0x100000, 1), //confirmed
    //2 = unknown
    EXPRATE(0x400000, 1),
    ACASH_RATE(0x800000, 1),
    ILLUSION(0x1000000, 1), //hack buffstat
    //1 = unknown, and for gms, 2 and 4 are unknown
    BERSERK_FURY(GameConstants.GMS ? 0x8000000 : 0x2000000, 1),
    DIVINE_BODY(GameConstants.GMS ? 0x10000000 : 0x4000000, 1),
    SPARK(GameConstants.GMS ? 0x20000000 : 0x8000000, 1),
    ARIANT_COSS_IMU2(GameConstants.GMS ? 0x40000000 : 0x10000000, 1), // no idea, seems the same
    FINALATTACK(GameConstants.GMS ? 0x80000000 : 0x20000000, 1),
    //4 = unknown
    ...
    BEHOLDER(0x40000, 1/*GameConstants.GMS ? 0x2000000 : 0x800000, 4*/),
    //1 = debuff
    ...
    MONSTER_RIDING(0x4000, 1/*0x10000000, 8*/),
