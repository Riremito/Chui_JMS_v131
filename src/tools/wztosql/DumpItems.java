...
public class DumpItems {
	private MapleDataProvider item, string = MapleDataProviderFactory.getDataProvider(new File(System.getProperty("net.sf.odinms.wzpath") + "/String.wz")), character;
    	protected final MapleData cashStringData = string.getData("Item.img");
    	protected final MapleData consumeStringData = string.getData("Item.img");
    	protected final MapleData eqpStringData = string.getData("Item.img");
   	protected final MapleData etcStringData = string.getData("Item.img");
    	protected final MapleData insStringData = string.getData("Item.img");
    	protected final MapleData petStringData = string.getData("Item.img");
